...
- [x] Fresh verification: 13 client suites/120 tests, 11 server unit files/76 tests, and 8 server integration files/77 tests passed; both typechecks, both lints, the server build, the production image build, and the Expo web export passed.
